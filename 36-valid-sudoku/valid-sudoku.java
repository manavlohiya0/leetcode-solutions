    ...
    public boolean isValidSudoku(char[][] board) {
        ...
        for (int r = 0; r < 9; r++){
            for (int c=0; c < 9; c++){
                ...
                if (rows.getOrDefault(r, new HashSet<>()).contains(cell) || cols.getOrDefault(c, new HashSet<>()).contains(cell) || squares.getOrDefault((r/3)*3 + c/3, new HashSet<>()).contains(cell)){
                    return false;
                }
